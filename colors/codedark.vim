...
call <sid>hi('IncSearch', s:cdBack, s:cdYellowOrange, 'none', {})
...
call <sid>hi('Search', s:cdBack, s:cdFront, 'none', {})
call <sid>hi('SpecialKey', s:cdBlue, s:cdNone, 'none', {})
call <sid>hi('SpellBad', s:cdBack, s:cdRed, 'undercurl', {})
call <sid>hi('SpellCap', s:cdBack, s:cdBlue, 'undercurl', {})
call <sid>hi('SpellLocal', s:cdBack, s:cdLightGreen, 'undercurl', {})
